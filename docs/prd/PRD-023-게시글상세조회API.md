# PRD-023 — 게시글 상세 조회 API

**이슈**: #20 · **명세**: [기능명세서 v0.3](../requirement/기능명세서%20v0.3.md) §6.2 · §6.3 · **작성**: 2026-09-06
...
이슈는 기능명세서 v0.2 §6.2 를 인용하지만 **정본은 v0.3** 이다. 착수 시 v0.3 §6.2·§6.3 을
다시 읽어 대조했고 **상세 조회 관련 내용은 v0.2 와 동일**했다. v0.3 이 바꾼 것은
§6.4 댓글의 게스트 처리("로그인 후 열람할 수 있어요")이며 이 사이클의 범위가 아니다.
...
응답 모양은 [ADR-0040](../adr/0040-post-detail-single-type-with-nested-vote-section.md) 이 정한다.
요약하면:
