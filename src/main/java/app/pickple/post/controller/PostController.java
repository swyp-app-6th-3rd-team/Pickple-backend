...
public class PostController {
     ...
     *
     * <p>응답 모양은 ADR-0041 이 정한다. 유형별로 타입을 쪼개지 않고 한 모양으로 두되,
     ...
     *
     * @param voteCount  득표 수. <b>투표하지 않았으면 이 필드가 없다</b> (ADR-0041)
    ...
    public record OptionItem(
            ...
            // 1인 1표라(R-09) 나머지가 역산되므로 반드시 함께 없어야 한다 (ADR-0041).
