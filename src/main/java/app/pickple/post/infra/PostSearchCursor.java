...
record PostSearchCursor(String queryHash, LocalDateTime createdAt, long id) {

    private static final String KIND = "post-search";
    private static final int VERSION = 1;
    private static final String KIND_KEY = "kind";
    private static final String VERSION_KEY = "version";
    private static final String QUERY_HASH_KEY = "queryHash";
    private static final String CREATED_AT_KEY = "createdAt";
    private static final String ID_KEY = "id";
    private static final Set<String> REQUIRED_KEYS = Set.of(
            KIND_KEY, VERSION_KEY, QUERY_HASH_KEY, CREATED_AT_KEY, ID_KEY);
    ...
    static PostSearchCursor from(ScrollPosition position, String keyword) {
        ...
        if (!keys.keySet().equals(REQUIRED_KEYS)
                ...
                || !BigInteger.ONE.equals(toInteger(keys.get(VERSION_KEY)))
                || !(keys.get(QUERY_HASH_KEY) instanceof String actualHash)
    ...
    static KeysetScrollPosition toPosition(String keyword, LocalDateTime createdAt, long id) {
        ...
        keys.put(QUERY_HASH_KEY, hash(keyword));
