...
public interface AppleProviderTokenStore {
    ...
    Optional<StoredAppleProviderToken> findByUserIdAndClientType(Long userId, AppleClientType clientType);

    List<StoredAppleProviderToken> findAllByUserId(Long userId);
